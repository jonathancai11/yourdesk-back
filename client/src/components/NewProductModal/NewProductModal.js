...
import { deleteProduct, addProductProperties, hideModal, deselectAllProducts } from '../../redux/actions';
...
export default function NewProductModal() {
  ...
  const currentProduct = useSelector(store => store.currentProduct.currentProduct);
  ...
  const handleFormSubmit = (event) => {
    ...
    // currentProduct.pros = properties.cons;
        ...
        <Form onSubmit={handleFormSubmit}>
          ...
          <Form.Group controlId="brand" as={Row}>
            <Form.Label column sm="2">Brand</Form.Label>
              <Col sm="10">
            <Form.Control placeholder="Apple" />
            </Col>
          </Form.Group>
          ...
          <Form.Group controlId="model" as={Row}>
            ...
            <Col sm="10">
              <Form.Control placeholder="Macbook Pro" />
            </Col>
          </Form.Group>
          ...
          <Form.Group controlId="url" as={Row}>
            ...
            <Col sm="10">
              <Form.Control placeholder="https://www.amazon.com/Apple-MacBook-13-inch-Storage-Keyboard/dp/B0882KD98F/ref=sr_1_1_sspa"/>
            </Col>
          </Form.Group>
          ...
          <Form.Group controlId="cost">
            <InputGroup className="mb-3">
              ...
              <Form.Control type="text" aria-label="Amount (to the nearest dollar)" placeholder={1199.99} />
            </InputGroup>
          </Form.Group>
